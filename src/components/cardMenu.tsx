...
import { PopularCar } from "@/sanity/lib/queries";
...
export const CardData = ()=>{
  ...
  useEffect(()=>{
    async function fetchCarData(){
      const fetchedData:CarType[]= await client.fetch(PopularCar)
      ...
      <div className="bg-[#FFFFFF] h-[388px] w-[317px] rounded-xl hover: border-blue-900">
            <div className=" mt-[20px] ml-[24px] gap-1">
               ...
               <p className="text-gray-500 text-[14px]">{car.type}</p>
                ...
                <h2 className="text-black text-[20px] ml-4 font-bold">{car.pricePerDay}<sub className="text-gray-500">/day</sub></h2><br/>
